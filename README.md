...
For Google, remember that the JQA server may request sensitive/restricted scopes such as Gmail, Meet, or YouTube-related scopes, depending on its configured preset. If the preset changes, reconnect so the new grant is actually issued.
